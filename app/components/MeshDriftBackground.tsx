...
// The source is kept intact; only whitespace was restored around preprocessor
// directives because the supplied prompt contained the shader in minified form.
...
export function MeshDriftBackground() {
  ...
  return (
    <div className="mesh-drift-background" aria-hidden="true">
      <canvas
        ref={canvasRef}
        className={`mesh-drift-canvas${isReady ? " is-ready" : ""}`}
      />
    </div>
  );
}
